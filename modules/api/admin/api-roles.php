...
$xtpl->assign('modifier', 'date', 'nv_date');
...
$xtpl->assign('SITE_MODS', $site_mods);
...
$xtpl->assign('IS_SUBMIT_FORM', $is_submit_form);
$xtpl->assign('ERROR', $error);
$xtpl->assign('TOTAL_API_ENABLED', $total_api_enabled);
$xtpl->assign('ARRAY_API_TREES', $array_api_trees);
$xtpl->assign('ARRAY_API_CONTENTS', $array_api_contents);
