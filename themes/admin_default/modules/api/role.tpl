    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <select class="form-control" id="id_weight_{VIEW.role_id}" onchange="nv_change_weight('{VIEW.role_id}');">
                        <!-- BEGIN: addtime_loop -->
...
<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
    ...
    <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.role_data}</strong> <span class="red">(*)</span></label>
        <div class="col-sm-19 col-md-20">
            <textarea class="form-control" style="height:100px;" cols="75" rows="5" name="role_data">{ROW.role_data}</textarea>
        </div>
    </div>
